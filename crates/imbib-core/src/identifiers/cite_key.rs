...
pub(crate) fn generate_cite_key_internal(
...
pub fn generate_cite_key(
    ...
    generate_cite_key_internal(author, year, title)
}

pub(crate) fn generate_unique_cite_key_internal(
    author: Option<String>,
    year: Option<String>,
    title: Option<String>,
    ...
    make_cite_key_unique(base, existing_set.into_iter().collect())
}
...
pub fn generate_unique_cite_key(
    ...
    generate_unique_cite_key_internal(author, year, title, existing_keys)
}

pub(crate) fn make_cite_key_unique_internal(base: String, existing_keys: Vec<String>) -> String {
...
pub fn make_cite_key_unique(base: String, existing_keys: Vec<String>) -> String {
    make_cite_key_unique_internal(base, existing_keys)
}
...
pub(crate) fn sanitize_cite_key_internal(key: String) -> String {
    key.chars()
...
pub fn sanitize_cite_key(key: String) -> String {
    sanitize_cite_key_internal(key)
}

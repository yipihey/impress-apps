...
impl SearchIndex {
    ...
    pub fn open(path: &Path) -> Result<Self, SearchIndexError> {
        ...
        Ok(Self {
            ...
            cite_key_field: schema
                .get_field(fields::CITE_KEY)
                .expect("schema missing 'cite_key' field"),
            title_field: schema
                .get_field(fields::TITLE)
                .expect("schema missing 'title' field"),
            authors_field: schema
                .get_field(fields::AUTHORS)
                .expect("schema missing 'authors' field"),
            abstract_field: schema
                .get_field(fields::ABSTRACT)
                .expect("schema missing 'abstract' field"),
            full_text_field: schema
                .get_field(fields::FULL_TEXT)
                .expect("schema missing 'full_text' field"),
            year_field: schema
                .get_field(fields::YEAR)
                .expect("schema missing 'year' field"),
            journal_field: schema
                .get_field(fields::JOURNAL)
                .expect("schema missing 'journal' field"),
            tags_field: schema
                .get_field(fields::TAGS)
                .expect("schema missing 'tags' field"),
            notes_field: schema
                .get_field(fields::NOTES)
                .expect("schema missing 'notes' field"),
            doi_field: schema
                .get_field(fields::DOI)
                .expect("schema missing 'doi' field"),
            arxiv_id_field: schema
                .get_field(fields::ARXIV_ID)
                .expect("schema missing 'arxiv_id' field"),
            library_id_field: schema
                .get_field(fields::LIBRARY_ID)
                .expect("schema missing 'library_id' field"),
            index,
            reader,
            schema,
        })

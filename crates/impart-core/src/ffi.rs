...
pub fn thread_messages(
    envelopes: Vec<crate::ffi_types::Envelope>,
) -> Vec<crate::ffi_types::Thread> {
...
impl FfiImapClient {
    ...
    pub fn list_mailboxes(&self) -> Result<Vec<crate::ffi_types::Mailbox>> {
        let mut guard = self
            .inner
            .lock()
            .map_err(|_| ImpartError::Imap("Lock poisoned".to_string()))?;
    ...
    pub fn fetch_envelopes(
        ...
        start: u32,
        count: u32,
    ) -> Result<Vec<crate::ffi_types::Envelope>> {
        let mut guard = self
            .inner
            .lock()
            .map_err(|_| ImpartError::Imap("Lock poisoned".to_string()))?;
    ...
    pub fn fetch_message(
        ...
        mailbox_name: String,
        uid: u32,
    ) -> Result<crate::ffi_types::ParsedMessage> {
        let mut guard = self
            .inner
            .lock()
            .map_err(|_| ImpartError::Imap("Lock poisoned".to_string()))?;

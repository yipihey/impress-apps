//! ADS personal library management endpoints.
...
impl AdsClient {
    ...
    pub async fn list_libraries(&self) -> Result<Vec<Library>> {
        ...
        let parsed: serde_json::Value = serde_json::from_str(&body)
            .map_err(|e| AdsError::Parse(format!("Invalid libraries response: {}", e)))?;
    ...
    pub async fn get_library(&self, id: &str) -> Result<LibraryDetail> {
        let body = self
            ...
            .await?;
        let parsed: serde_json::Value = serde_json::from_str(&body)
            .map_err(|e| AdsError::Parse(format!("Invalid library response: {}", e)))?;
    ...
    pub async fn create_library(
        ...
        let parsed: serde_json::Value = serde_json::from_str(&response_body)
            .map_err(|e| AdsError::Parse(format!("Invalid create library response: {}", e)))?;

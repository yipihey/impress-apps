...
struct AITasksSettingsView: View {
    ...
    var body: some View {
        Form {
            Section {
                Label(
                    "Tasks run on \(aiService.currentSelectionDescription). Turn tasks on or off, or edit a task's prompt. Disabled ones are hidden from the editor's cell-bracket and selection AI menus.",

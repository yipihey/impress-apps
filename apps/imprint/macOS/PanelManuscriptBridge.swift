...
//  flanking panels (Throughline; the Veusz panel it once served is gone — figures
//  are project rows, ADR-0030). The shared chassis has no
...
//  → ImprintStoreAdapter). imbib never constructs one.
//

...
#if canImport(impel_toolsFFI)
import impel_toolsFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_impel_tools_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_impel_tools_rustbuffer_free(self, $0) }
    }
}
 ...
 */
public struct ToolBackends {
    public var imbib: Backend
    public var imprint: Backend

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(imbib: Backend, imprint: Backend) {
        self.imbib = imbib
...
extension ToolBackends: Equatable, Hashable {
    public static func ==(lhs: ToolBackends, rhs: ToolBackends) -> Bool {
        if lhs.imbib != rhs.imbib {
            return false
        }
        if lhs.imprint != rhs.imprint {
            return false
        }
        return true
    }
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeToolBackends: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ToolBackends {
        return
            try ToolBackends(
                imbib: FfiConverterTypeBackend.read(from: &buf), 
                imprint: FfiConverterTypeBackend.read(from: &buf)
        )
    }

    public static func write(_ value: ToolBackends, into buf: inout [UInt8]) {
        FfiConverterTypeBackend.write(value.imbib, into: &buf)
        FfiConverterTypeBackend.write(value.imprint, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeToolBackends_lift(_ buf: RustBuffer) throws -> ToolBackends {
    return try FfiConverterTypeToolBackends.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeToolBackends_lower(_ value: ToolBackends) -> RustBuffer {
    return FfiConverterTypeToolBackends.lower(value)
}
...
extension ToolDescriptor: Equatable, Hashable {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeToolDescriptor: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ToolDescriptor {
        return
            try ToolDescriptor(
    ...
    public static func write(_ value: ToolDescriptor, into buf: inout [UInt8]) {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeToolDescriptor_lift(_ buf: RustBuffer) throws -> ToolDescriptor {
    return try FfiConverterTypeToolDescriptor.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeToolDescriptor_lower(_ value: ToolDescriptor) -> RustBuffer {
    return FfiConverterTypeToolDescriptor.lower(value)
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeBackend: FfiConverterRustBuffer {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeBackend_lift(_ buf: RustBuffer) throws -> Backend {
    return try FfiConverterTypeBackend.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeBackend_lower(_ value: Backend) -> RustBuffer {
    return FfiConverterTypeBackend.lower(value)
}



extension Backend: Equatable, Hashable {}
...
public enum ToolError {
     ...
     */
    case AppUnavailable(app: String, name: String
    )
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeToolError: FfiConverterRustBuffer {
    typealias SwiftType = ToolError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ToolError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
    ...
    public static func write(_ value: ToolError, into buf: inout [UInt8]) {
        switch value {
...
extension ToolError: Equatable, Hashable {}

extension ToolError: Foundation.LocalizedError {
    public var errorDescription: String? {
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeToolDescriptor: FfiConverterRustBuffer {
    typealias SwiftType = [ToolDescriptor]

    public static func write(_ value: [ToolDescriptor], into buf: inout [UInt8]) {
        let len = Int32(value.count)
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeToolDescriptor.write(item, into: &buf)
        }
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [ToolDescriptor] {
        let len: Int32 = try readInt(&buf)
        var seq = [ToolDescriptor]()
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeToolDescriptor.read(from: &buf))
        }
        return seq
    }
}
 ...
 */
public func callTool(name: String, argsJson: String)throws  -> String {
...
public func configure(imbibUrl: String?, imprintUrl: String?) -> ToolBackends {
    ...
    uniffi_impel_tools_fn_func_configure(
        FfiConverterOptionString.lower(imbibUrl),
        FfiConverterOptionString.lower(imprintUrl),$0
    )
})
}
/**
 ...
 */
public func listAvailableTools() -> [ToolDescriptor] {
    return try!  FfiConverterSequenceTypeToolDescriptor.lift(try! rustCall() {
    uniffi_impel_tools_fn_func_list_available_tools($0
    )
})
}
/**
...
private var initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_impel_tools_uniffi_contract_version()
